(function () {
  ...
  const generate = (length = 32, options = { mix: true, numeric: false, underscore: false, uppercase: false, special: [] }, cb = undefined) => {
  ...
  generate({ underscore: true, numeric: true }, (result) => {
    console.log(result);
  })

  generate({ underscore: true, alphabetic: true })
    .then((result) => console.log(result))

  (typeof module !== 'undefined') ? module.exports = generate : window.generate = generate;
